          ...
          <Stack direction="row" alignItems="center" spacing={2}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography variant="body2" color="text.secondary">
                All locations are maintaining consistent week-over-week revenue
                performance. No significant drops detected.
              </Typography>
            </Box>
            <IconButton
            ...
            <Stack spacing={2}>
              <Box>
                <Typography
                  ...
                  sx={{ mb: 1 }}
                >
                  This system monitors week-over-week revenue changes to
                ...
                <Stack direction="row" spacing={3} flexWrap="wrap">
                  ...
                  <Stack direction="row" alignItems="center" spacing={1}>
                    ...
                    />
                    <Typography variant="caption">
                      10-20% drop: Investigation needed
                    </Typography>
                  </Stack>
                  <Stack direction="row" alignItems="center" spacing={1}>
                    <Box
                    ...
                    />
                    <Typography variant="caption">
                      &gt;20% drop: Immediate action required
                    </Typography>
                  </Stack>
                </Stack>
              </Box>
                ...
                >
                  <AlertTitle sx={{ fontWeight: 600 }}>
                    <Stack direction="row" alignItems="center" spacing={1}>
                      ...
                      <span>
                        ...
                        {comparison.changePercentage < 0 ? "Drop" : "Increase"}
                      </span>
                    </Stack>
                  </AlertTitle>
                  ...
                  <Stack spacing={1.5}>
                    <Box>
                      ...
                      <Typography variant="body2">
                        Last Week:{" "}
                        {formatCurrency(comparison.previousWeekTotal)}
                      </Typography>
                    ...
                    {comparison.dailyAlerts.length > 0 && (
                      ...
                      >
                        ...
                        {comparison.dailyAlerts.length > 1 ? "s" : ""} had
                        significant drops (&gt;7%)
                      </Typography>
                    )}
                    ...
                    {Math.abs(comparison.changePercentage) > 15 && (
                      ...
                      >
                        ...
                        >
                          ...
                          <li>
                            Compare with same period last month for patterns
                          </li>
                        </Typography>
                      </Box>
                    )}
                            ...
                            <TableBody>
                              {comparison.dailyAlerts.map((alert) => (
                                <TableRow key={alert.date}>
                                  ...
                                  <TableCell align="right">
                                    <Chip
                                      label={`-${alert.dropPercentage.toFixed(
                                        1
                                      )}%`}
                                      size="small"
                                      color={
